...
--upgrade variables
    ...
    player1 = Paddle(10, 30, 5, 20, 10, 70,"Player 1")
    player2 = Paddle(VIRTUAL_WIDTH - 10, VIRTUAL_HEIGHT - 30, 5, 20, VIRTUAL_WIDTH - 70, VIRTUAL_WIDTH - 10,"Player 2")
...
function love.update(dt)
    ...
    elseif gameState == 'play' then
        ...
        if ball.x < 0 then
            ...
            sounds['score']:play()
            disadvantaged_player = player1
            upgrade_name, disadvantaged_player = upgrades(disadvantaged_player, player2Score)
...
function love.draw()
    ...
    if gameState == 'start' then
        ...
        love.graphics.printf('Score 7 Win!', 0, 20, VIRTUAL_WIDTH, 'center')
    ...
    elseif gameState == 'serve' then
        ...
        if has_upgrade then
          displayUpgrade(disadvantaged_player, upgrade_name)
        end
    elseif gameState == 'play' then
          has_upgrade = false
...
--[[
    upgrades that happen in order to make the game bit more fun
    paddle increase upgrade 
    random movement upgrade
]]
...
function displayUpgrade(disadvantaged_player, upgrade_name)
  
  --displays upgrade
  love.graphics.setFont(smallFont)
  
  if upgrade_name == "paddle increase" then
    love.graphics.printf(disadvantaged_player._name .. " got the " .. tostring(upgrade_name) .. " upgrade"  ,0, 60, VIRTUAL_WIDTH, 'center')
  else
     love.graphics.printf(disadvantaged_player._name .. " got the " .. tostring(upgrade_name) .. " upgrade\ngo backwards while hitting the ball to use",0, 60, VIRTUAL_WIDTH, 'center')
  end
  end
end